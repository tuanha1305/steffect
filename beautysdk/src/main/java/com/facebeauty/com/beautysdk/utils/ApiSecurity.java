...
/**
 * Created by liupan on 17/8/17.
 */

public class ApiSecurity {
//    private static final String IV_STRING = Global.getConfig("security.iv_string") ;
//    private static final String KEY = Global.getConfig("security.key") ;

    private static final String IV_STRING = "A-16-Byte-String" ;
    private static final String KEY = "TcU@Rt2AhWBjVBA%" ;
