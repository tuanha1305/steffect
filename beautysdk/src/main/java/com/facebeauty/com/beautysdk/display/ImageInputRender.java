...
public class ImageInputRender {
    ...
    public void makeup(STPoint[] stPoint240, int texture_jaw, float scale,float jawsale)
    {
        if( stPoint240 != null) {
            nativeChangeFaceAndJaw(stPoint240,texture_jaw,scale,jawsale);
    ...
    {
        nativeChangeFaceAndJaw(points, texid, 0.5f, 0.5f);
        return OpenGLUtils.ON_DRAWN;
    }
