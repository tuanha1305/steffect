...
public class STBeautifyNative {
     ...
     * @return 成功返回0，错误返回其他，参考STUtils.ResultCode
     */
    public native int processTextureAndOutputBuffer(int textureIn, int outputWidth, int outputHeight, STMobile106[] arrayFacesIn, int textureOut, byte[] outputBuf, int format, STMobile106[] arrayFacesOut);
