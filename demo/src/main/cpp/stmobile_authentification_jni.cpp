...
JNIEXPORT jint JNICALL Java_com_sensetime_stmobile_STMobileAuthentificationNative_checkActiveCodeFromBuffer(JNIEnv * env, jobject obj, jstring licenseBuffer, jint licenseSize, jstring activationCode, jint codeSize);
};
...
//    int license_size = licenseSize;
    int res = st_mobile_check_activecode_from_buffer(targetLicenseBuffer, licenseSize, activationCodeString);
